...
These examples assume you have initialized a `RelayClient`. See [Setup](./polymarket-auth.md) for client initialization.
...
See [Negative Risk Overview](./polymarket-api-overview.md) for details.
...
|----------|---------|---------|
| CTF (Conditional Token Framework) | `0x4d97dcd97ec945f40cf65f87097ace5ea0476045` | Polygon |
| USDCe (Collateral) | `0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174` | Polygon |
| Neg Risk Adapter | `0xd91E80cF2E7be2e162c6513ceD06f1dD0dA35296` | Polygon |
| Neg Risk CTF Exchange | `0xC5d563A36AE78145C45a50134d48A1215220f80a` | Polygon |

---

## Related Documentation

- [CTF Overview](./polymarket-api-overview.md) - Conditional Token Framework basics
- [Redeeming Positions](./redeeming-positions.md) - Detailed redemption documentation
- [Polymarket Auth](./polymarket-auth.md) - Relayer Client setup
- [Trading Rules](./TRADING_RULES.md) - Best practices for trading operations
